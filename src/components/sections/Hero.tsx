  ...
  return <section className="relative min-h-screen overflow-hidden pt-24 lg:pt-28 pb-8">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          {/* Subheading */}
          <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto mb-6 leading-relaxed">One powerful platform for unlimited cinemas. Ticketing software, booking websites, custom domains, and role based dashboards all in one place.</p>
