      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-bold text-foreground leading-tight mb-6">
            ...
            <span style={{ color: '#4F46E5' }}>Cinema Ticketing</span>{" "}
            Solution
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <div className="w-5 h-5 rounded flex items-center justify-center" style={{ backgroundColor: '#4F46E5' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="group gap-2 px-7 py-6 text-base font-semibold rounded-full shadow-lg hover:shadow-xl transition-all"
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="px-7 py-6 text-base font-semibold rounded-full border-2 border-foreground/20 bg-white hover:bg-secondary/50"
            >
              Request a Demo
            </Button>
          </div>
        ...
        <div className="relative max-w-5xl mx-auto px-4 lg:px-8">
          ...
          <div className="absolute -right-4 lg:-right-8 top-1/4 z-20 hidden lg:block">
            <div className="px-5 py-2.5 rounded-lg shadow-lg" style={{ backgroundColor: '#4F46E5' }}>
          ...
          <div className="absolute -right-4 lg:-right-8 bottom-1/3 z-20 hidden lg:block">
            <div className="flex items-center gap-2 bg-white px-4 py-2.5 rounded-lg shadow-lg border border-gray-100">
              <div className="w-6 h-6 rounded-full" style={{ backgroundColor: '#4F46E5' }} />
              <span className="text-sm font-medium text-foreground">Gate Staff</span>
            </div>
          </div>

          {/* Main Dashboard Image */}
          <div className="relative rounded-2xl overflow-hidden bg-white border border-gray-200" style={{ boxShadow: '0 25px 50px -12px rgba(79, 70, 229, 0.15), 0 12px 24px -8px rgba(0, 0, 0, 0.1)' }}>
            <img
              src={dashboardImage}
